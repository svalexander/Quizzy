...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == Cheat_Request){
            ...
            Toast.makeText(this, "Your result code is " + resultCode, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.cheat_button:
                Toast.makeText(this, "Show Cheat Mode", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(this, CheatActivity.class);
                //another way to get the current question and anser in a putExtra
 //               Question currentQuestion = questionBank[currentIndex];
//                String questionStr = getResources().getString(currentQuestion.getTextResId()); //question at the r.id
